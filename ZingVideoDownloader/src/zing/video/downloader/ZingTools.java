...
public class ZingTools {
	public static final String SDCARD_FOLDER = "/ZingVideoDownloader/";
	public static final String FILE_POSTFIX = ".mp4";
...
//		getListSongs("http://mp3.zing.vn/tim-kiem/bai-hat.html?q=khong+cam+xuc");
//		getListSongs("http://mp3.zing.vn/tim-kiem/bai-hat.html?q=mưa&p=1");
//		http://mp3.zing.vn/tim-kiem/bai-hat.html?q=m%C6%B0a&p=1
	...
	public static void addSongToPlaylist(Context context, String playlistName, String songId) {
		Log.e("stk", "addSongToPlaylist : playlistName=" + playlistName + "; songId=" + songId);
	...
	public static void deleteSongFromAllPlaylist(Context context, String songId) {
		...
		Log.e("stk", "listDownload=" + sharedPreferences.getString(NameSpace.SHARED_PREF_LIST_DOWNLOAD, ""));
		...
		for (int i = 0; i < listPlaylists.length; i++) {
			...
			if (!playlist.equals("")) {
				...
				Log.e("stk", "listDownload playlist=" + playlist + "=" + sharedPreferences.getString(playlist, ""));	
			}
		}
	}
	...
	public static String[] getIdsFromPlaylist(Context context, String playlistName) {
		...
		String[] listIds;
		if (playlistName.equals("")) {
			listIds = sharedPreferences.getString(NameSpace.SHARED_PREF_LIST_DOWNLOAD, "").trim().split("\\s+");
		} else {
			listIds = sharedPreferences.getString(playlistName, "").trim().split("\\s+");
		}
	...
	public static String checkSongOrVideoFileExist(String songOrVideoId) {
		...
		if (fileList != null) {
			for (int i = 0; i < fileList.length; i++) {
				if (fileList[i].contains(songOrVideoId) &&!fileList[i].contains(FILE_POSTFIX_DOWNLOAD))
...
//	public static boolean checkSongOrVideoDataExist(Context context, String songOrVideoId) {
//		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
//		return !sharedPreferences.getString(songOrVideoId, "").equals("");
//	}
