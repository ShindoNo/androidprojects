...
.method static final serializeToUrlConnection(Lcom/facebook/RequestBatch;Ljava/net/HttpURLConnection;)V
    ...
    invoke-virtual {v0, v1}, Lcom/facebook/RequestBatch;->get(I)Lcom/facebook/Request;

    move-result-object v1

    iget-object v0, v1, Lcom/facebook/Request;->httpMethod:Lcom/facebook/HttpMethod;

    move-object/from16 v17, v0

    .line 1903
    .local v17, "connectionHttpMethod":Lcom/facebook/HttpMethod;
    :goto_0
    invoke-virtual/range {v17 .. v17}, Lcom/facebook/HttpMethod;->name()Ljava/lang/String;
    ...
    invoke-static {v0, v6}, Lcom/facebook/Request;->setConnectionContentType(Ljava/net/HttpURLConnection;Z)V
    ...
    invoke-virtual {v0, v1, v4}, Lcom/facebook/internal/Logger;->appendKeyValue(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .end local v17    # "connectionHttpMethod":Lcom/facebook/HttpMethod;
    .end local v18    # "isPost":Z
    :cond_0
    sget-object v17, Lcom/facebook/HttpMethod;->POST:Lcom/facebook/HttpMethod;

    goto :goto_0

    .line 1919
    .restart local v4    # "url":Ljava/net/URL;
    .restart local v17    # "connectionHttpMethod":Lcom/facebook/HttpMethod;
    :cond_1
    const/16 v18, 0x0
    ...
    .line 1936
    .local v5, "countingStream":Lcom/facebook/ProgressNoopOutputStream;
    new-instance v5, Lcom/facebook/ProgressNoopOutputStream;

    .end local v5    # "countingStream":Lcom/facebook/ProgressNoopOutputStream;
    invoke-virtual/range {p0 .. p0}, Lcom/facebook/RequestBatch;->getCallbackHandler()Landroid/os/Handler;

    move-result-object v1

    invoke-direct {v5, v1}, Lcom/facebook/ProgressNoopOutputStream;-><init>(Landroid/os/Handler;)V

    .line 1937
    .restart local v5    # "countingStream":Lcom/facebook/ProgressNoopOutputStream;
    const/4 v2, 0x0

    move-object/from16 v1, p0

    invoke-static/range {v1 .. v6}, Lcom/facebook/Request;->processRequest(Lcom/facebook/RequestBatch;Lcom/facebook/internal/Logger;ILjava/net/URL;Ljava/io/OutputStream;Z)V

    .line 1939
    invoke-virtual {v5}, Lcom/facebook/ProgressNoopOutputStream;->getMaxProgress()I

    move-result v20

    .line 1940
    .local v20, "max":I
    invoke-virtual {v5}, Lcom/facebook/ProgressNoopOutputStream;->getProgressMap()Ljava/util/Map;

    move-result-object v10

    .line 1942
    .local v10, "progressMap":Ljava/util/Map;, "Ljava/util/Map<Lcom/facebook/Request;Lcom/facebook/RequestProgress;>;"
    ...
    invoke-direct/range {v7 .. v12}, Lcom/facebook/ProgressOutputStream;-><init>(Ljava/io/OutputStream;Lcom/facebook/RequestBatch;Ljava/util/Map;J)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .end local v5    # "countingStream":Lcom/facebook/ProgressNoopOutputStream;
    .end local v8    # "outputStream":Ljava/io/OutputStream;
    .end local v10    # "progressMap":Ljava/util/Map;, "Ljava/util/Map<Lcom/facebook/Request;Lcom/facebook/RequestProgress;>;"
    .end local v20    # "max":I
    .restart local v7    # "outputStream":Ljava/io/OutputStream;
    :goto_3
    ...
    .line 1945
    :try_start_2
    invoke-static/range {v11 .. v16}, Lcom/facebook/Request;->processRequest(Lcom/facebook/RequestBatch;Lcom/facebook/internal/Logger;ILjava/net/URL;Ljava/io/OutputStream;Z)V
    :try_end_2
