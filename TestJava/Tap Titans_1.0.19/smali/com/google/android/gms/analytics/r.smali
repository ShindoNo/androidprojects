...
.method private declared-synchronized eh()V
    ...
    invoke-interface {v1}, Lcom/google/android/gms/analytics/f;->dO()Ljava/util/concurrent/LinkedBlockingQueue;

    move-result-object v1

    new-instance v2, Lcom/google/android/gms/analytics/r$1;

    invoke-direct {v2, p0}, Lcom/google/android/gms/analytics/r$1;-><init>(Lcom/google/android/gms/analytics/r;)V
    ...
    :cond_1
    :try_start_1
    iget-boolean v1, p0, Lcom/google/android/gms/analytics/r;->yA:Z
    ...
    :goto_1
    :pswitch_1
    iget-object v1, p0, Lcom/google/android/gms/analytics/r;->yv:Ljava/util/Queue;
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/r;->yd:Lcom/google/android/gms/analytics/d;

    invoke-virtual {v6}, Lcom/google/android/gms/analytics/r$d;->em()Ljava/util/Map;

    move-result-object v2

    invoke-virtual {v6}, Lcom/google/android/gms/analytics/r$d;->en()J

    move-result-wide v3

    invoke-virtual {v6}, Lcom/google/android/gms/analytics/r$d;->getPath()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v6}, Lcom/google/android/gms/analytics/r$d;->eo()Ljava/util/List;
    ...
    :cond_3
    iget-boolean v1, p0, Lcom/google/android/gms/analytics/r;->yg:Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/r;->ys:Lcom/google/android/gms/analytics/b;
    ...
    :cond_5
    iget-object v1, p0, Lcom/google/android/gms/analytics/r;->yD:Lcom/google/android/gms/internal/ju;

    invoke-interface {v1}, Lcom/google/android/gms/internal/ju;->elapsedRealtime()J

    move-result-wide v1

    iput-wide v1, p0, Lcom/google/android/gms/analytics/r;->yq:J
...
.method public dH()V
    ...
    iput-boolean v3, p0, Lcom/google/android/gms/analytics/r;->yA:Z
