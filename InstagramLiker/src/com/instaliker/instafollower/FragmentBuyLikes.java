...
public class FragmentBuyLikes extends Fragment {
	...
	public void initUI() {
		...
		seekBar.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				((TextView) mainLayout.findViewById(R.id.tv_spend_coins)).setText(String.format(template, spendCoins
						/ LIKE_PRICE, spendCoins - spendCoins % LIKE_PRICE));
				return false;
			}
		});
		...
		mainLayout.findViewById(R.id.btn_spend_coins).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				builder.setMessage(String.format(templateBuyLikes, spendCoins / LIKE_PRICE, spendCoins - spendCoins
						% LIKE_PRICE));
			...
			public void onClick(View v) {
				...
				dialog.findViewById(R.id.btn_ok).setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						((TextView) mainLayout.findViewById(R.id.tv_spend_coins)).setText(String.format(template,
								spendCoins / LIKE_PRICE, spendCoins - spendCoins % LIKE_PRICE));
					}
				});
	...
	public void setDataImage(final JSONObject imgJSON) {
		...
		try {
			...
			ImageLoader.getInstance().displayImage(imgUrl, (ImageView) mainLayout.findViewById(R.id.img_spend_coins));
