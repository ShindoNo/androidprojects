		...
		try {
			...
			((TextView)mainLayout.findViewById(R.id.tv_followers)).setText(followed_by);
			 ...
			 seekBar.setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					((TextView)mainLayout.findViewById(R.id.tv_buy_followers)).setText(String.format(template, coins/FOLLWER_PRICE, coins - coins%FOLLWER_PRICE));
			...
			mainLayout.findViewById(R.id.btn_buy_followers).setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					builder.setMessage(String.format(templateBuyConfirm, spendCoins/FOLLWER_PRICE, spendCoins - spendCoins%FOLLWER_PRICE));
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				String params = "access_token=" + Util.getAccessToken(mContext) +
								"&follower_needed=" + (spendCoins/FOLLWER_PRICE);
