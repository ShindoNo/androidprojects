...
public class SoloSDK {
	...
	public void init() {
		...
		SimpleFacebookConfiguration facebookConfiguration = new SimpleFacebookConfiguration.Builder()
															...
															.setAppId(Utils.getString(mActivity, NameSpace.SAVED_FACEBOOK_APP_ID))
															.build();
	...
	/**
	 * Show login form, allow user login with different options and callback after login successful
